...
public class LoginRegistro extends JFrame{
    private static LoginRegistro instance;
    ...
    /**
    * Constructor privado para la clase LoginRegistro.
    */
    private LoginRegistro(){
        super("Gym Manager Registro Login");
        setLayout(null);
        setResizable(false);
        ...
        jlblTitulo = new JLabel("Departemento de Registro");
        ...
        jbtnAceptar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e){
                try{
                    ...
                    empleado = Registro.registrarLogin(userName, password);

                    if(userName.equals(empleado.getUserName()) &&
                        password.equals(empleado.getPassword())  ){
                        jtxtUser.setText("");
                        jtxtClave.setText("");
                        MenuRegistro.getInstance().setLoggedUser(empleado);
                        MenuRegistro.getInstance().setVisible(true);
    ...
    * <p>
    * 
    * @return la instancia actual de la clase Login de Registro  y si no
