...
public class LoginServiciosAdministrativos extends JFrame{
    private static LoginServiciosAdministrativos instance;
    ...
    /**
    * Constructor privado para la clase LoginServiciosAdministrativos.
    */
    private LoginServiciosAdministrativos(){
        super("Gym Manager Administracion Login");
        setLayout(null);
        setResizable(false);
        ...
        jlblTitulo = new JLabel("Departemento de Servicios Administrativos");
    ...
    */
    private void crearComponentes(){   
        ...
        jlblTitulo.setBounds(10, 20, 500, 30);
        ...
        jbtnAceptar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e){
                try{
                    ...
                    empleado = ServiciosAdministrativos.registrarLogin(userName, password);

                    if(userName.equals(empleado.getUserName()) &&
                        password.equals(empleado.getPassword())  ){
                        jtxtUser.setText("");
                        jtxtClave.setText("");
                        MenuServiciosAdministrativos.getInstance().setLoggedUser(empleado);
                        MenuServiciosAdministrativos.getInstance().setVisible(true);
    ...
    * <p>
    * 
    * @return la instancia actual de la clase Login de Servicios Administrativos 
    * y si no existe ninguna la crea y luego la retorna
    *
    */
    public static LoginServiciosAdministrativos getInstance(){
        
        if(instance == null){
            instance = new LoginServiciosAdministrativos();           
        }
