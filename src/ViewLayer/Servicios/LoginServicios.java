...
public class LoginServicios extends JFrame{
    private static LoginServicios instance;
    ...
    /**
    * Constructor privado para la clase LoginServicios.
    */
    private LoginServicios(){
        super("Gym Manager Servicios Login");
        setLayout(null);
        setResizable(false);
        ...
        jlblTitulo = new JLabel("Departemento de Servicios");
        ...
        jbtnAceptar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    empleado = Servicios.registrarLogin(userName, password);

                    if(userName.equals(empleado.getUserName()) &&
                        password.equals(empleado.getPassword())  ){
                        jtxtUser.setText("");
                        jtxtClave.setText("");
                        MenuServicios.getInstance().setLoggedUser(empleado);
                        MenuServicios.getInstance().setVisible(true);
                    ...
                    JOptionPane.showMessageDialog(instance, ex.getCause().toString());
    ...
    * <p>
    * 
    * @return la instancia actual de la clase Login de Servicios y si no
    * existe ninguna la crea y luego la retorna
    *
    */
    public static LoginServicios getInstance(){
        
        if(instance == null){
            instance = new LoginServicios();           
        }
